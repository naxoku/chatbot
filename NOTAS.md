...
4. Arreglas los quickActions que aparecen al momento de escribir un mensaje.0

5. Revisar cómo hacer para implementar los botones de feedback (los pulgares bajo los mensajes del bot).
6. Estructurar mejor los quickActions del chat y hacer más limpia esa interfaz.
