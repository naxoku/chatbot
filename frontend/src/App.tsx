...
const App: React.FC = () => {
  ...
  const checkInitialAuth = async (retries = 2): Promise<void> => {
    try {
      ...
      // Reintentar si hay errores de conexión
      if (retries > 0) {
        console.log(`🔄 Reintentando verificación de sesión... (${2 - retries + 1}/2)`);
        await new Promise(resolve => setTimeout(resolve, 500));
        return checkInitialAuth(retries - 1);
      }
