        ...
        <div className="w-full max-w-4xl">
          <div className="flex gap-3 justify-start">
            <div className="w-full md:max-w-[70%]">
              ...
              `}</style>
              <div className="p-4 rounded-tl-lg rounded-tr-lg rounded-br-md bg-muted inline-flex items-center gap-1.5 min-w-[56px]">
                <span className="thinking-dot w-2 h-2 rounded-full bg-muted-foreground block" />
                <span className="thinking-dot w-2 h-2 rounded-full bg-muted-foreground block" />
                <span className="thinking-dot w-2 h-2 rounded-full bg-muted-foreground block" />
              </div>
            </div>
