  ...
  return (
    <div className="p-4">
      <form onSubmit={handleSubmit} className="space-y-2">
        {quotedMessage && (
          <div
            className={`flex items-start p-2.5 rounded-lg border-l-2 text-xs ${
              isDarkMode
                ? "bg-gray-800 border-blue-500 text-gray-400"
          ...
          >
            <div className="flex-1 overflow-hidden">
              ...
              <p className="line-clamp-2 opacity-80">{quotedMessage.content}</p>
            </div>
            <button
              type="button"
        ...
        <div
          className={`flex gap-2 items-end rounded-xl p-3 ${
        ...
        >
          <div className="flex-1">
            <textarea
              ...
              disabled={isTyping}
              rows={1}
              className={`w-full resize-none bg-transparent border-none focus:outline-none overflow-hidden ${
                isDarkMode
          ...
          >
            ...
            >
              <i
                className={`fas ${
                  isTyping ? "fa-spinner fa-spin" : "fa-arrow-up"
                } text-sm`}
              />
            </button>
          </Tooltip>
